...
#undef STR
        ...
        void exitFatal(std::string message, VkResult resultCode) { exitFatal(message, (int32_t) resultCode); }
        ...
        bool fileExists(const std::filesystem::path& filename) { fileExists(filename.string()); }
    }
}