...
void r8_f10(double t, double y[], double yp[]);
...
//
{
    ...
    cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12) << y[0] << "  " << setw(12) << yp[0] << "  "
         << setw(12) << r4_y1x(t) << "  " << setw(12) << y[0] - r4_y1x(t) << "\n";
    ;

    for (i_step = 1; i_step <= n_step; i_step++)
    {
        t = ((float) (n_step - i_step + 1) * t_start + (float) (i_step - 1) * t_stop) / (float) (n_step);

        t_out = ((float) (n_step - i_step) * t_start + (float) (i_step) *t_stop) / (float) (n_step);
...
//
{
    ...
    cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12) << y[0] << "  " << setw(12) << y[1] << "\n";
...
#define NEQN 1
    ...
    cout << setw(4) << flag << "  " << setw(12) << t << "  " << setw(12) << y[0] << "  " << setw(12) << yp[0] << "  "
         << setw(12) << r8_y1x(t) << "  " << setw(12) << y[0] - r8_y1x(t) << "\n";
    ;

    for (i_step = 1; i_step <= n_step; i_step++)
    {
        t = ((double) (n_step - i_step + 1) * t_start + (double) (i_step - 1) * t_stop) / (double) (n_step);

        t_out = ((double) (n_step - i_step) * t_start + (double) (i_step) *t_stop) / (double) (n_step);
...
void test10()
{
    ...
    flag = r8_rkf45(geo, 1, y, yp, &t, t_out, &relerr, abserr, flag);
